...
export default function ChatWithFiles() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (validFiles.length !== selectedFiles.length) {
      toast.error("Only PDF and PPTX files under 5MB are allowed.");
    }
        ...
        <CardHeader className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <CardTitle className="text-2xl font-bold">
              PDF & PPTX Quiz Generator
            </CardTitle>
            <CardDescription className="text-base">
              Upload a PDF or PowerPoint to generate an interactive quiz based on its content
            ...
            >
              ...
              <p className="text-sm text-muted-foreground text-center">
                {files.length > 0 ? (
                  ...
                  <span>Drop your PDF or PPTX here or click to browse.</span>
                )}
              </p>
            </div>
            <Button
